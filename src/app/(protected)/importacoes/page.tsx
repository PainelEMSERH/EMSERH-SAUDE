...
export default async function ImportacoesPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-xl border border-primary-border bg-primary-soft/60 p-5">
        <h3 className="font-semibold text-primary">Espelho Google Sheets</h3>
      ...
      <div className="space-y-4 rounded-xl border border-border bg-card p-5 text-sm text-foreground/80">
